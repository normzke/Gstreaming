        ...
        <table class="admin-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-secondary" onclick="editPackage(<?php echo $package['id']; ?>)">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn btn-danger btn-delete" onclick="deletePackage(<?php echo $package['id']; ?>)">
