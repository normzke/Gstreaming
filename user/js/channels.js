...
const bingetvUserChannelStyleSheet = document.createElement('style');
bingetvUserChannelStyleSheet.textContent = notificationStyles;
document.head.appendChild(bingetvUserChannelStyleSheet);
