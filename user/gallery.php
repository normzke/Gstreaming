...
$statsQuery = "SELECT 
               ...
               COUNT(CASE WHEN created_at >= DATE_SUB(NOW(), INTERVAL 1 MONTH) THEN 1 END) as recent_uploads
...
function downloadPhoto(photoId) {
    window.location.href = `download-photo.php?id=${photoId}`;
}
...
function downloadSelected() {
    ...
    window.location.href = `download-photos.php?ids=${ids.join(',')}`;
}
