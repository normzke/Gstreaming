...
<div class="stats-grid">
    ...
    <div class="stat-card">
        ...
        <div class="stat-value"><?php echo $subscription ? ($subscription['max_devices'] ?? 1) : 'N/A'; ?></div>
        <div class="stat-change positive">
            <i class="fas fa-arrow-up"></i>
            Simultaneous
        </div>
                    ...
                    <tbody>
                        <?php foreach ($payments as $payment): ?>
                            <tr>
                                ...
                                <td><?php echo $payment['currency'] ?? 'KES'; ?>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem;">
                <?php foreach ($availablePackages as $package): ?>
                    <div
                        ...
                        <div style="text-align: center;">
                            <a href="../subscriptions/subscribe?package=<?php echo $package['id']; ?>" class="btn btn-primary">
                                <i class="fas fa-credit-card"></i>
                                Subscribe Now
                            </a>
                        </div>
