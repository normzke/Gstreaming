        ...
        <div class="faq-list">
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p>To subscribe to a package, go to the Packages page, select your desired package, and follow the payment process. You can pay using M-PESA or other available payment methods.</p>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p>Once you have an active subscription, go to the Channels page and click on any channel to start watching. You can watch on multiple devices based on your package limits.</p>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p>You can cancel your subscription from your Dashboard. Go to the Subscriptions section and click on "Cancel Subscription". Your access will continue until the end of your current billing period.</p>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p>We accept M-PESA, Airtel Money, and other mobile money services. We also accept credit/debit cards for international payments.</p>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p>The number of devices depends on your package. Basic packages allow 1 device, while premium packages allow up to 5 devices simultaneously.</p>
                </div>
            </div>
        </div>
    </div>
...
function replyTicket(ticketId) {
    window.location.href = `ticket-details.php?id=${ticketId}&reply=1`;
}
