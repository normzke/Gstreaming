...
public final class ChannelDao_Impl implements ChannelDao {
  ...
  @Override
  public PagingSource<Integer, ChannelEntity> getAllChannelsPaged() {
    final String _sql = "SELECT * FROM channels ORDER BY sortOrder ASC, name ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return new LimitOffsetPagingSource<ChannelEntity>(_statement, __db, "channels") {
      @Override
      protected List<ChannelEntity> convertRows(Cursor cursor) {
        final int _cursorIndexOfId = CursorUtil.getColumnIndexOrThrow(cursor, "id");
        final int _cursorIndexOfStreamId = CursorUtil.getColumnIndexOrThrow(cursor, "streamId");
        ...
        final int _cursorIndexOfTvgId = CursorUtil.getColumnIndexOrThrow(cursor, "tvgId");
        final int _cursorIndexOfTvgName = CursorUtil.getColumnIndexOrThrow(cursor, "tvgName");
        final int _cursorIndexOfTvgLogo = CursorUtil.getColumnIndexOrThrow(cursor, "tvgLogo");
        final int _cursorIndexOfTvgChno = CursorUtil.getColumnIndexOrThrow(cursor, "tvgChno");
        ...
        final int _cursorIndexOfIsLocked = CursorUtil.getColumnIndexOrThrow(cursor, "isLocked");
        final int _cursorIndexOfSortOrder = CursorUtil.getColumnIndexOrThrow(cursor, "sortOrder");
        final int _cursorIndexOfAddedAt = CursorUtil.getColumnIndexOrThrow(cursor, "addedAt");
        final List<ChannelEntity> _result = new ArrayList<ChannelEntity>(cursor.getCount());
        while(cursor.moveToNext()) {
          final ChannelEntity _item;
          final long _tmpId;
          _tmpId = cursor.getLong(_cursorIndexOfId);
          final String _tmpStreamId;
          if (cursor.isNull(_cursorIndexOfStreamId)) {
            _tmpStreamId = null;
          } else {
            _tmpStreamId = cursor.getString(_cursorIndexOfStreamId);
          }
          final String _tmpName;
          ...
          final String _tmpTvgId;
          if (cursor.isNull(_cursorIndexOfTvgId)) {
            _tmpTvgId = null;
          } else {
            _tmpTvgId = cursor.getString(_cursorIndexOfTvgId);
          }
          final String _tmpTvgName;
          if (cursor.isNull(_cursorIndexOfTvgName)) {
            _tmpTvgName = null;
          } else {
            _tmpTvgName = cursor.getString(_cursorIndexOfTvgName);
          }
          final String _tmpTvgLogo;
          if (cursor.isNull(_cursorIndexOfTvgLogo)) {
            _tmpTvgLogo = null;
          } else {
            _tmpTvgLogo = cursor.getString(_cursorIndexOfTvgLogo);
          }
          final String _tmpTvgChno;
          if (cursor.isNull(_cursorIndexOfTvgChno)) {
            _tmpTvgChno = null;
          } else {
            _tmpTvgChno = cursor.getString(_cursorIndexOfTvgChno);
          }
          final String _tmpEpgChannelId;
          ...
          final boolean _tmpIsLocked;
          final int _tmp_1;
          _tmp_1 = cursor.getInt(_cursorIndexOfIsLocked);
          _tmpIsLocked = _tmp_1 != 0;
          final int _tmpSortOrder;
  ...
  @Override
  public PagingSource<Integer, ChannelEntity> getChannelsByCategoryPaged(final String category) {
    final String _sql = "SELECT * FROM channels WHERE category = ? ORDER BY sortOrder ASC, name ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (category == null) {
  ...
  @Override
  public PagingSource<Integer, ChannelEntity> getFavoriteChannelsPaged() {
    final String _sql = "SELECT * FROM channels WHERE isFavorite = 1 ORDER BY sortOrder ASC, name ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return new LimitOffsetPagingSource<ChannelEntity>(_statement, __db, "channels") {
      @Override
  ...
  @Override
  public PagingSource<Integer, ChannelEntity> searchChannelsPaged(final String query) {
    final String _sql = "SELECT * FROM channels WHERE name LIKE '%' || ? || '%' OR category LIKE '%' || ? || '%'";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
    if (query == null) {
  ...
  @Override
  public List<ChannelEntity> getChannelsByStreamIds(final List<String> streamIds) {
    StringBuilder _stringBuilder = StringUtil.newStringBuilder();
    _stringBuilder.append("SELECT * FROM channels WHERE streamId IN (");
    final int _inputSize = streamIds.size();
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        final long _tmpAddedAt;
        _tmpAddedAt = _cursor.getLong(_cursorIndexOfAddedAt);
        _item_1 = new ChannelEntity(_tmpId,_tmpStreamId,_tmpName,_tmpStreamUrl,_tmpLogoUrl,_tmpCategory,_tmpCategoryId,_tmpTvgId,_tmpTvgName,_tmpTvgLogo,_tmpTvgChno,_tmpEpgChannelId,_tmpIsFavorite,_tmpIsLocked,_tmpSortOrder,_tmpAddedAt);
        _result.add(_item_1);
      }
      return _result;
    } finally {
